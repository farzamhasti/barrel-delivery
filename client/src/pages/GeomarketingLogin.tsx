...
export default function GeomarketingLogin() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex flex-col">
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-2">
          <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-green-600 mx-auto mb-4">
            <Lock className="w-6 h-6 text-white" />
          </div>
          <CardTitle className="text-2xl text-center">Geomarketing</CardTitle>
          <CardDescription className="text-center">
            Enter your credentials to access the geomarketing dashboard
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              {isLoading || loginMutation.isPending ? (
                ...
                "Login to Geomarketing Dashboard"
              )}
            </Button>
