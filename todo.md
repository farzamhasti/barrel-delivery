...
- [x] Display receipt photo in Kitchen Dashboard (receiptImage field available)
- [x] Display receipt photo in Order Tracking (receiptImage field available)
- [x] Test camera and upload functionality (Form compiles, dev server running)
