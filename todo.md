...
## Phase 58: GPS-Based Driver Location Tracking
- [ ] Add GPS location capture to driver dashboard on login
- [ ] Request geolocation permission from driver's browser
- [ ] Create tRPC procedure: drivers.updateLocation(latitude, longitude)
- [ ] Implement continuous GPS tracking while driver is online
- [ ] Update tracking map to show driver's GPS location instead of restaurant
- [ ] Store driver location in database with timestamp
- [ ] Handle location permission denial gracefully
- [ ] Test GPS tracking end-to-end across all dashboards


## Phase 58: GPS-Based Driver Location Tracking
- [x] Add latitude, longitude, location_updated_at columns to drivers table
- [x] Create drivers.updateLocation tRPC procedure to store GPS coordinates
- [x] Fix useGeolocation hook to use correct tRPC procedure
- [x] Apply database migration to add location columns
- [x] Add driver markers to tracking map showing GPS location (or restaurant if no GPS)
- [x] Update both regular and fullscreen maps to display driver locations
